...
file_int = 'Mesh_interna/Roble_sin_hueco_Norm/OUTPUT_FILES/AA.S0001.BXX.semd';
file_ext = 'Mesh_externa/Roble_R_sin_hueco_PML_T/OUTPUT_FILES/AA.S0001.BXX.semd';
DT_int   = 2.0e-7;   % s
DT_ext   = 2.0e-7;   % s
...
fprintf('  Ambas mallas: DT=2e-7s, NSTEP=3000, roble anisótropo (c11=2.54GPa)\n');
