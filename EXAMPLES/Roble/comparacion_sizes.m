...
dirs = {
    'Mesh_interna/Roble_sin_hueco_Malla/OUTPUT_FILES/',    'Sin hueco',   0,    NaN;
    'Mesh_interna/Roble_con_hueco_N_C/OUTPUT_FILES/',   '10x10 cm', 10.0,   10.0;
    'Mesh_interna/Roble_con_hueco_N_C_Mediano/OUTPUT_FILES/',     '5x5 cm',    5.0,    5.0;
    'Mesh_interna/Roble_con_hueco_N_C_Pequeño/OUTPUT_FILES/',     '2x2 cm',    2.0,    2.0;
};
...
V_rad   = 1896.8;   % m/s  (θ=0°, Christoffel con tus c_ij)
V_tang  = 1382.8;   % m/s  (θ=90°)
Vp_air  = 343.0;    % m/s
...
title('Sismogramas: roble con huecos de distintos tamaños','FontSize',11);
