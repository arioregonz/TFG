...
dirs = {
    'Mesh_interna/Pino_sin_hueco_Norm/OUTPUT_FILES/',       'Sin hueco';
    'Mesh_interna/Pino_con_hueco_N_C/OUTPUT_FILES/',     'Centro';
    'Mesh_interna/Pino_con_hueco_N_UR/OUTPUT_FILES/',         'UR';
    'Mesh_interna/Pino_con_hueco_N_UL/OUTPUT_FILES/',         'UL';
    'Mesh_interna/Pino_con_hueco_N_DL/OUTPUT_FILES/',         'DL';
    'Mesh_interna/Pino_con_hueco_N_DR/OUTPUT_FILES/',         'DR';
};
N_casos = size(dirs,1);
...
for k = 1:N_casos
    ...
    ref_pos = {
        ...
        'UR',     '~<5% (solo difracción, no en ruta)';
        'UL',     '~<5% (solo difracción, no en ruta)';
        'DL',     '~<5% (solo difracción, no en ruta)';
        'DR',     '~<5% (solo difracción, no en ruta)';
    };
...
fprintf('    La asimetría refleja la anisotropía del pino (V_rad>V_tang)\n');
