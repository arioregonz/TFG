...
archivos = {
    'Mesh_externa/Pino_C_sin_hueco_N_2/OUTPUT_FILES/AA.S0001.BXX.semd', 'Sano',        0.0;
    'Mesh_externa/Pino_C_hueco_7.6_T/OUTPUT_FILES/AA.S0001.BXX.semd', 'Hueco Ø10cm', 10.0;
    'Mesh_externa/Pino_C_hueco_5.1_T/OUTPUT_FILES/AA.S0001.BXX.semd',     'Hueco Ø5cm',  5.0;
    'Mesh_externa/Pino_C_hueco_2.9_T/OUTPUT_FILES/AA.S0001.BXX.semd',     'Hueco Ø2cm',  2.0;
};

% Referencia interna (hueco cuadrado, para comparar tendencia)
archivos_int = {
    'Mesh_interna/Pino_con_hueco_N_C/OUTPUT_FILES/AA.S0001.BXX.semd',          '10x10cm', 10.0;
    'Mesh_interna/Pino_con_hueco_N_C_Mediano/OUTPUT_FILES/AA.S0001.BXX.semd',  '5x5cm',   5.0;
    'Mesh_interna/Pino_con_hueco_N_C_Pequeño/OUTPUT_FILES/AA.S0001.BXX.semd',  '2x2cm',   2.0;
};
...
A_si=load('Mesh_interna/Pino_sin_hueco_Norm/OUTPUT_FILES/AA.S0001.BXX.semd');
